...
/// Cheeses section: selected InputChips + available ActionChips + L/W/R.
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text('Cheeses', style: Theme.of(context).textTheme.titleMedium),
        const SizedBox(height: 4),
        Text(
          'Up to $maxCheeses. Selected cheeses are free if they came on the item.',
          style: Theme.of(
            context,
