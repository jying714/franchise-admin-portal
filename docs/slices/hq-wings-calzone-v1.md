...
**Status**: **Complete** (W0–W7) — W2 franchise pool remains optional follow-on  
...
| Sauce pool | Items **bind** existing ingredients; franchise shared pool is **W2 optional** |
...
- M5 dual-tree deletion (separate epic gate)  
