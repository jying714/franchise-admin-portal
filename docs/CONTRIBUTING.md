...
Small, reviewable PRs only. Human approval required for payments, auth, security, and major architecture changes

### 4. Multi-Agent Development

Orchestrator coordinates specialized agents (Mobile + Shared Core, Web Frontend, Backend, etc.)
Every agent follows the constitution in their prompt files
...
Update relevant documentation (ARCHITECTURE.md, DASHBOARDS.md, ROADMAP.md, etc.)
Request review from project maintainer
Merge only after approval and successful builds

### 7. Documentation

Keep ARCHITECTURE.md, DASHBOARDS.md, MOBILE_DYNAMIC.md, and ROADMAP.md up to date
All major decisions should be recorded
