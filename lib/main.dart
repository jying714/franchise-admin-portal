    ...
    runApp(
      MultiProvider(
        providers: [
          ...
          // You can add more global providers if needed
        ],
        child: FranchiseAdminPortalRoot(),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/admin/dashboard': (_) =>
            const AdminProviders(child: AdminDashboardScreen()),
        '/developer/dashboard': (_) =>
            const AdminProviders(child: DeveloperDashboardScreen()),
        '/developer/select-franchise': (_) =>
            const AdminProviders(child: FranchiseSelectorScreen()),
        '/hq-owner/dashboard': (_) =>
            const AdminProviders(child: OwnerHQDashboardScreen()),
...
class AdminProviders extends StatelessWidget {
  final Widget child;
  const AdminProviders({required this.child, super.key});
