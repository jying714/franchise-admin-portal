                  ...
                  children: [
                            ...
                            builder: (context) {
                              final firestoreService =
                                  Provider.of<FirestoreService>(context,
                                      listen: false);
                              final franchiseId =
                                  Provider.of<FranchiseProvider>(context,
                                          listen: false)
                                      .franchiseId;
                              final analyticsService =
                    ...
                    Expanded(
                      child: StreamBuilder<List<AnalyticsSummary>>(
                        stream: Provider.of<AnalyticsService>(context,
                                listen: false)
                            .getSummaryMetrics(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.hasError) {
                            ErrorLogger.log(
                              ...
                              severity: 'error',
                              contextData: {
                                'franchiseId': Provider.of<FranchiseProvider>(
                                        context,
                                        listen: false)
                                    .franchiseId,
                              },
                              ...
                              children: [
                                  ...
                                  child: ListView(
                                    children: (() {
                                      ...
                                      return [
                                        ...
                                        _buildMetricTile("Most Popular Item",
                                            summary.mostPopularItem ?? "-",
                                            isMissing: missingMetrics
                                        ...
                                        _buildMetricTile("Unique Customers",
                                            summary.uniqueCustomers ?? "-",
                                            isMissing: missingMetrics
                                                .contains('uniqueCustomers')),
                                        _buildMetricTile("Cancelled Orders",
                                            summary.cancelledOrders ?? "-",
                                            isMissing: missingMetrics
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton.icon(
                                    icon: const Icon(Icons.download_rounded),
                                    label:
                                        const Text('Export This Period (CSV)'),
                                    style: ElevatedButton.styleFrom(
                                      backgroundColor:
